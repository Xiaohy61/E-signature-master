...
public class HandPlatService extends Service{
    //Log用的TAG
    private static final String TAG = "HandPlatService";
    ...
    private void createToucher()
    {
        ...
        //获取浮动窗口视图所在布局.
        toucherLayout = inflater.inflate(R.layout.item_overlay,null);
        //添加toucherlayout
        ...
        //浮动窗口按钮.
        imageButton1 = toucherLayout.findViewById(R.id.ib_handplat);
       /* imageButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               Toast.makeText(HandPlatService.this,"onclick",Toast.LENGTH_LONG).show();
            }
        });*/
        ...
        //toucherLayout.setLongClickable(true);
